...
ActiveRecord::Schema[7.0].define(version: 2024_01_04_002310) do
  ...
  create_table "order_delivery_addresses", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["delivery_address_id"], name: "index_order_delivery_addresses_on_delivery_address_id"
    t.index ["order_id"], name: "index_order_delivery_addresses_on_order_id"
  end
